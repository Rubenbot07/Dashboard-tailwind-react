...
export const Header = () => {
  ...
  return (
    <header className='bg-Very-Pale-Blue dark:bg-Very-Dark-Blue-Top h-auto rounded-b-3xl pt-8 px-6 pb-20'>
      <div className='md:w-[80%] md:mx-auto'>
        ...
        <hr className='bg-Dark-Grayish-Blue h-[1px] mb-5 border-none md:hidden' />
        <div className='flex justify-between'>
          ...
          <label htmlFor='darkmode' className='bg-Toggle w-12 h-6 rounded-full cursor-pointer p-[2px] relative'>
            ...
            <div className='w-5 h-5 bg-Light-Grayish-Blue rounded-full translate-x-6 peer-checked:translate-x-0  peer-checked:bg-Very-Dark-Blue-Top transition-all' />
          </label>
        </div>
      </div>
    </header>
